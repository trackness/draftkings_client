...
from draft_kings.output.contests import EntriesDetails, ContestDetails, ContestsDetails


class TestLoadingEntriesDetailsSchema(TestCase):
    def setUp(self) -> None:
        self.schema = EntriesDetails.schema()
...
class TestLoadingContestDetailsSchema(TestCase):
    def setUp(self) -> None:
        self.schema = ContestDetails.schema()
...
class TestContestsDetailsSchema(TestCase):
    def setUp(self) -> None:
        self.schema = ContestsDetails.schema()
