...
from draft_kings.output.draftables import PlayerNameDetails, PlayerImageDetails, PlayerTeamDetails, \
...
class TestPlayerNameDetailsDeserialization(TestCase):
    def setUp(self) -> None:
        self.schema = PlayerNameDetails.schema()
...
class TestPlayerImageDetailsDeserialization(TestCase):
    def setUp(self) -> None:
        self.schema = PlayerImageDetails.schema()
...
class TestPlayerDetails(TestCase):
    def setUp(self) -> None:
        self.schema = PlayerDetails.schema()
...
class TestCompetitionDetails(TestCase):
    def setUp(self) -> None:
        self.schema = CompetitionDetails.schema()
