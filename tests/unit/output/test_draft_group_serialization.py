...
from draft_kings.output.draft_group import StartTimeDetails
...
class TestStartTimeDetailsSerialization(TestCase):
    def test_when_none_values(self):
        self.assertEqual(
            ...
            StartTimeDetails.schema().dump(StartTimeDetails(maximum=None, minimum=None, type_description=None))
        )

    def test_when_empty_object(self):
        self.assertEqual(
            {},
            StartTimeDetails.schema().dump({})
        )
    ...
    def test_when_timezone_aware_datetime_objects(self):
        ...
        self.assertDictEqual(
            ...
            StartTimeDetails.schema().dump(StartTimeDetails(maximum=maximum_start_time, minimum=minimum_start_time,
                                                           type_description="jaebaebae"))
        )
