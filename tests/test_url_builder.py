...
class TestUrlBuilder:
    ...
    def test_build_countries(self) -> None:
    ...
    def test_available_players(self) -> None:
        assert "https://www.draftkings.com/lineup/getavailableplayers" == self.under_test.available_players()

    def test_draft_group(self) -> None:
        assert "https://api.draftkings.com/draftgroups/v1/12345" == self.under_test.draft_groups(12345)

    def test_draftables(self) -> None:
        assert "https://api.draftkings.com/draftgroups/v1/draftgroups/12345/draftables" == self.under_test.draftables(12345)

    def test_game_type_rules(self) -> None:
        assert "https://api.draftkings.com/lineups/v1/gametypes/12345/rules" == self.under_test.game_type_rules(12345)
